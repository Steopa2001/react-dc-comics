...
function App() {
    ...
    },
    {
      ...
      thumb:
        "https://www.freecomicbookday.com/SiteImage/MainImage/STK651157",
      price: "$3.99",
      series: "Batman",
    ...
    },
    {
      ...
      thumb:
        "https://images-na.ssl-images-amazon.com/images/S/compressed.photo.goodreads.com/books/1550691643i/40996659.jpg",
      price: "$16.99",
      series: "Catwoman",
  ...
  // Link Navbar
  const navbarLinks = [
    { id: 1, label: "CHARACTERS", href: "#", current: false },
    { id: 2, label: "COMICS", href: "#", current: true },
    { id: 3, label: "MOVIES", href: "#", current: false },
    { id: 4, label: "TV", href: "#", current: false },
    { id: 5, label: "GAMES", href: "#", current: false },
    { id: 6, label: "COLLECTIBLES", href: "#", current: false },
    { id: 7, label: "VIDEOS", href: "#", current: false },
    { id: 8, label: "FANS", href: "#", current: false },
    { id: 9, label: "NEWS", href: "#", current: false },
    { id: 10, label: "SHOP", href: "#", current: false },
  ];
...
// Icon Bar
const iconBarItems = [
  { src:'/img/buy-comics-digital-comics.png', label:"DIGITAL COMICS" },
  { src:'/img/buy-comics-merchandise.png', label:"MERCHANDISE" },
  { src:'/img/buy-comics-subscriptions.png', label:"SUBSCRIPTIONS" },
  { src:'/img/buy-comics-shop-locator.png', label:"SHOP LOCATOR" },
  { src:'/img/buy-dc-power-visa.svg', label:"DC POWER VISA" },
];
  ...
  return (
    <>
      ...
      <Main comics={comics} iconBarItems={iconBarItems}/>
      <Footer links={footerLinks} socialIcons={socialIcons}/>
    </>
  );
}
